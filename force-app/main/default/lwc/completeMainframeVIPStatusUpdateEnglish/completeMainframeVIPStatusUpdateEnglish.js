...
import { OMNIDEF } from './completeMainframeVIPStatusUpdateEnglish_def.js';
import tmpl from './completeMainframeVIPStatusUpdateEnglish.html';
import tmpl_nds from './completeMainframeVIPStatusUpdateEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class completeMainframeVIPStatusUpdateEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
