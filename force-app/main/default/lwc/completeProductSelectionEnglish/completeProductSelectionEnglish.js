...
import { OMNIDEF } from './completeProductSelectionEnglish_def.js';
import tmpl from './completeProductSelectionEnglish.html';
import tmpl_nds from './completeProductSelectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class completeProductSelectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
