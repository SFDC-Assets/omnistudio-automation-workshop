...
import { OMNIDEF } from './buildProductSelectionEnglish_def.js';
import tmpl from './buildProductSelectionEnglish.html';
import tmpl_nds from './buildProductSelectionEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class buildProductSelectionEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
